...
from ansible_collections.ansible.docker.plugins.module_utils.docker.common import update_tls_hostname, get_connect_params
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'ansible.docker.docker_swarm'
